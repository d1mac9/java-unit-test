...
public void checkIsAdultWhenAgeIsLessThan18False(){
    ...
    assertEquals("Должно вернуться false, пользователь не совершеннолетний", false, isAdult);
}
...
public void checkIsAdultWhenAgeIs18True(){
    ...
    assertEquals("Должно вернуться true, пользователь совершеннолетний", true, isAdult);
}
